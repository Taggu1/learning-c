// Name: ch10_project4.c
// Purpose: Forth project of chapter 10
...
flush = false, straight = false, royal = false;
int pairs = 0;
...
void analyze_hand() {
    ...
    int royalCount = 0;
    for (int i = 0; i < RANKS_NUM; i++) {
        if (i >= 8 && num_in_ranks[i] != 0) royalCount += num_in_ranks[i];
